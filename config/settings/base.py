"""
Base settings for Productive Bandwidth Allocation project.
...
LOCAL_APPS = [
    # custom users app
    'productive_bandwidth_allocation.users.apps.UsersConfig',
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'productive_bandwidth_allocation.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Faiz Borkar""", 'borkarfaiz@gmail.com'),
]
